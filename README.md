...
Šis projekts ir Unity balstīta viktorīnas spēle, kas pārbauda lietotāja zināšanas par Unity UI sistēmu. Projekts izmanto C# programmēšanas valodu un Unity dzinēju, lai izveidotu interaktīvu lietotāja saskarni ar jautājumiem un atbilžu izvēlēm.

## Funkcionalitāte

- Spēle satur 10 jautājumus par Unity UI sistēmu.
- Katram jautājumam ir 4 atbilžu varianti, no kuriem 2 vai 3 ir pareizi.
- Lietotājs atbild uz katru jautājumu vienu reizi.
- Beigās tiek parādīts, cik jautājumi ir atbildēti pareizi un uz kuriem jautājumiem tika atbildēts nepareizi.
- Ir iespēja mēģināt vēlreiz, sākot spēli no jauna.

## Uzstādīšana

1. Lejupielādējiet vai klonējiet šo repozitoriju uz savu datoru.
2. Atveriet projektu ar Unity.
3. Pārliecinieties, ka visi nepieciešamie faili un skripti ir projektā.

## Lietošana

1. Palaidiet spēli Unity Editor vai veiciet build, lai palaistu to kā atsevišķu aplikāciju.
2. Sekojiet instrukcijām ekrānā un atbildiet uz jautājumiem.
3. Beigās apskatiet rezultātus un, ja nepieciešams, mēģiniet vēlreiz.
